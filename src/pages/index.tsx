...
export const getStaticProps: GetStaticProps = async () => {
  const { data }= await api.get("episodes", {
    params: {
      _limit: 12, // Passando um parametro de limite 12 registros
      _sort: "published_at", // Ordenado pela data de publicação
  ...
  return{
    ...
    revalidate: 60 * 60 * 8, // Atualizando a pagina a cada 8 horas || 3 vezes por dia
  }
}